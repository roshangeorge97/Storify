...
GOOGLE_AI_STUDIO = "AIzaSyCBZvuXrtfMTS5kCyB65c0VdFDQWzfU7io"
...
HEADERS = {"Authorization": "Bearer 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"}
...
headers = {"Authorization": f"Bearer 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"}
